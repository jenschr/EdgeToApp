...
modified to look better using Bootstrap
02.02.2023 by Jens Chr Brynildsen 
*/
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<head><title>LED Control</title>");
            ...
            client.println("<meta name='theme-color' content='#712cf9'>");
            client.println("</head>");
            client.println("<body>");
            client.println("<section class='py-5 text-center container'>");
            client.println("<h1 class='fw-light'>LED Control</h1>");
            client.println("<p class='lead text-muted'>");
            client.println("Click <a href=\"/H\">here</a> to turn the LED on.</br></br>");
